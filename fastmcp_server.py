# -*- coding: utf-8 -*-
# Auto-generated by codegen/gen.py. DO NOT EDIT.
...
# Tool wrapper for NinjaKiwiAPI.get_btd6_races
@mcp.tool
async def get_btd6_races(
    context: fastmcp.server.context.Context,) -> list[Btd6race] | None:
    """
    A list of all available Race events
    URL: /btd6/races
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_races()

# Tool wrapper for NinjaKiwiAPI.get_btd6_races_by_race_id_leaderboard
@mcp.tool
async def get_btd6_races_by_race_id_leaderboard(
    context: fastmcp.server.context.Context,    race_id: str,) -> list[Btd6raceleaderboard] | None:
    """
    A race leaderboard
    URL: /btd6/races/:raceID/leaderboard
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_races_by_race_id_leaderboard(race_id=race_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_races_by_race_id_metadata
@mcp.tool
async def get_btd6_races_by_race_id_metadata(
    context: fastmcp.server.context.Context,    race_id: str,) -> Btd6challengedocument | None:
    """
    Metadata for a race event
    URL: /btd6/races/:raceID/metadata
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_races_by_race_id_metadata(race_id=race_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_bosses
@mcp.tool
async def get_btd6_bosses(
    context: fastmcp.server.context.Context,) -> list[Btd6boss] | None:
    """
    List all available Boss events
    URL: /btd6/bosses
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_bosses()

# Tool wrapper for NinjaKiwiAPI.get_btd6_bosses_by_boss_id_leaderboard_by_type_by_team_size
@mcp.tool
async def get_btd6_bosses_by_boss_id_leaderboard_by_type_by_team_size(
    context: fastmcp.server.context.Context,    boss_id: str,    type: str,    team_size: str,) -> list[Btd6bossleaderboard] | None:
    """
    Load a Boss event leaderboard
    URL: /btd6/bosses/:bossID/leaderboard/:type/:teamSize
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_bosses_by_boss_id_leaderboard_by_type_by_team_size(boss_id=boss_id,type=type,team_size=team_size)

# Tool wrapper for NinjaKiwiAPI.get_btd6_bosses_by_boss_id_metadata_by_difficulty
@mcp.tool
async def get_btd6_bosses_by_boss_id_metadata_by_difficulty(
    context: fastmcp.server.context.Context,    boss_id: str,    difficulty: str,) -> Btd6challengedocument | None:
    """
    Load Boss event Metadata
    URL: /btd6/bosses/:bossID/metadata/:difficulty
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_bosses_by_boss_id_metadata_by_difficulty(boss_id=boss_id,difficulty=difficulty)

# Tool wrapper for NinjaKiwiAPI.get_btd6_users_by_user_id
@mcp.tool
async def get_btd6_users_by_user_id(
    context: fastmcp.server.context.Context,    user_id: str,) -> Btd6userprofile | None:
    """
    Load information about a BTD6 Player
    URL: /btd6/users/:userID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_users_by_user_id(user_id=user_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_challenges
@mcp.tool
async def get_btd6_challenges(
    context: fastmcp.server.context.Context,) -> list[Btd6challengetype] | None:
    """
    List all available Challenge Filters
    URL: /btd6/challenges
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_challenges()

# Tool wrapper for NinjaKiwiAPI.get_btd6_challenges_filter_by_challenge_filter
@mcp.tool
async def get_btd6_challenges_filter_by_challenge_filter(
    context: fastmcp.server.context.Context,    challenge_filter: str,) -> list[Btd6challenge] | None:
    """
    List challenges based on a filter
    URL: /btd6/challenges/filter/:challengeFilter
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_challenges_filter_by_challenge_filter(challenge_filter=challenge_filter)

# Tool wrapper for NinjaKiwiAPI.get_btd6_challenges_challenge_by_challenge_id
@mcp.tool
async def get_btd6_challenges_challenge_by_challenge_id(
    context: fastmcp.server.context.Context,    challenge_id: str,) -> Btd6challengedocument | None:
    """
    Get specific information about a challenge
    URL: /btd6/challenges/challenge/:challengeID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_challenges_challenge_by_challenge_id(challenge_id=challenge_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_ct
@mcp.tool
async def get_btd6_ct(
    context: fastmcp.server.context.Context,) -> list[Btd6ct] | None:
    """
    Load information about current and historical CT events
    URL: /btd6/ct
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_ct()

# Tool wrapper for NinjaKiwiAPI.get_btd6_ct_by_ct_id_tiles
@mcp.tool
async def get_btd6_ct_by_ct_id_tiles(
    context: fastmcp.server.context.Context,    ct_id: str,) -> Btd6cttile | None:
    """
    Load Information about the tiles from a CT event
    URL: /btd6/ct/:ctID/tiles
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_ct_by_ct_id_tiles(ct_id=ct_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_ct_by_ct_id_leaderboard_player
@mcp.tool
async def get_btd6_ct_by_ct_id_leaderboard_player(
    context: fastmcp.server.context.Context,    ct_id: str,) -> list[Btd6ctleaderboardplayer] | None:
    """
    Load Top Player Leaderboard for a CT event
    URL: /btd6/ct/:ctID/leaderboard/player
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_ct_by_ct_id_leaderboard_player(ct_id=ct_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_ct_by_ct_id_leaderboard_team
@mcp.tool
async def get_btd6_ct_by_ct_id_leaderboard_team(
    context: fastmcp.server.context.Context,    ct_id: str,) -> list[Btd6ctleaderboardteam] | None:
    """
    Load Top Team Leaderboard for a CT event
    URL: /btd6/ct/:ctID/leaderboard/team
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_ct_by_ct_id_leaderboard_team(ct_id=ct_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_ct_by_ct_id_leaderboard_group_by_group_id
@mcp.tool
async def get_btd6_ct_by_ct_id_leaderboard_group_by_group_id(
    context: fastmcp.server.context.Context,    ct_id: str,    group_id: str,) -> list[Btd6ctleaderboardteam] | None:
    """
    Load information about a Team's group
    URL: /btd6/ct/:ctID/leaderboard/group/:groupID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_ct_by_ct_id_leaderboard_group_by_group_id(ct_id=ct_id,group_id=group_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_guild_by_guild_id
@mcp.tool
async def get_btd6_guild_by_guild_id(
    context: fastmcp.server.context.Context,    guild_id: str,) -> Btd6guildprofile | None:
    """
    Load information about a BTD6 Team
    URL: /btd6/guild/:guildID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_guild_by_guild_id(guild_id=guild_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_odyssey
@mcp.tool
async def get_btd6_odyssey(
    context: fastmcp.server.context.Context,) -> list[Btd6odyssey] | None:
    """
    A list of all available Odyssey events
    URL: /btd6/odyssey
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_odyssey()

# Tool wrapper for NinjaKiwiAPI.get_btd6_odyssey_by_odyssey_id_by_difficulty
@mcp.tool
async def get_btd6_odyssey_by_odyssey_id_by_difficulty(
    context: fastmcp.server.context.Context,    odyssey_id: str,    difficulty: str,) -> Btd6odysseymetadata | None:
    """
    A odyssey event metadata
    URL: /btd6/odyssey/:odysseyID/:difficulty
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_odyssey_by_odyssey_id_by_difficulty(odyssey_id=odyssey_id,difficulty=difficulty)

# Tool wrapper for NinjaKiwiAPI.get_btd6_odyssey_by_odyssey_id_by_difficulty_maps
@mcp.tool
async def get_btd6_odyssey_by_odyssey_id_by_difficulty_maps(
    context: fastmcp.server.context.Context,    odyssey_id: str,    difficulty: str,) -> list[Btd6challengedocument] | None:
    """
    A odyssey event map information
    URL: /btd6/odyssey/:odysseyID/:difficulty/maps
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_odyssey_by_odyssey_id_by_difficulty_maps(odyssey_id=odyssey_id,difficulty=difficulty)

# Tool wrapper for NinjaKiwiAPI.get_btd6_save_by_oak_id
@mcp.tool
async def get_btd6_save_by_oak_id(
    context: fastmcp.server.context.Context,    oak_id: str,) -> Btd6usersave | None:
    """
    Load detailed information about a players' progress. Requires an OAK Token from the player
    URL: /btd6/save/:oakID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_save_by_oak_id(oak_id=oak_id)

# Tool wrapper for NinjaKiwiAPI.get_btd6_maps
@mcp.tool
async def get_btd6_maps(
    context: fastmcp.server.context.Context,) -> list[Btd6maptype] | None:
    """
    List all map filters
    URL: /btd6/maps
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_maps()

# Tool wrapper for NinjaKiwiAPI.get_btd6_maps_filter_by_map_filter
@mcp.tool
async def get_btd6_maps_filter_by_map_filter(
    context: fastmcp.server.context.Context,    map_filter: str,) -> list[Btd6map] | None:
    """
    List maps based on a filter
    URL: /btd6/maps/filter/:mapFilter
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_maps_filter_by_map_filter(map_filter=map_filter)

# Tool wrapper for NinjaKiwiAPI.get_btd6_maps_map_by_map_id
@mcp.tool
async def get_btd6_maps_map_by_map_id(
    context: fastmcp.server.context.Context,    map_id: str,) -> Btd6mapdocument | None:
    """
    Get specific information about a map
    URL: /btd6/maps/map/:mapID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_btd6_maps_map_by_map_id(map_id=map_id)

# Tool wrapper for NinjaKiwiAPI.get_battles2_homs
@mcp.tool
async def get_battles2_homs(
    context: fastmcp.server.context.Context,) -> list[Battles2hom] | None:
    """
    A list of current Hall of Masters events
    URL: /battles2/homs
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_homs()

# Tool wrapper for NinjaKiwiAPI.get_battles2_homs_by_hom_id_leaderboard
@mcp.tool
async def get_battles2_homs_by_hom_id_leaderboard(
    context: fastmcp.server.context.Context,    hom_id: str,) -> list[Battles2homleaderboard] | None:
    """
    A HoM leaderboard
    URL: /battles2/homs/:homID/leaderboard
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_homs_by_hom_id_leaderboard(hom_id=hom_id)

# Tool wrapper for NinjaKiwiAPI.get_battles2_users_by_user_id
@mcp.tool
async def get_battles2_users_by_user_id(
    context: fastmcp.server.context.Context,    user_id: str,) -> Battles2userprofile | None:
    """
    Information about a Battles 2 Player
    URL: /battles2/users/:userID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_users_by_user_id(user_id=user_id)

# Tool wrapper for NinjaKiwiAPI.get_battles2_users_by_user_id_matches
@mcp.tool
async def get_battles2_users_by_user_id_matches(
    context: fastmcp.server.context.Context,    user_id: str,) -> list[Battles2usermap] | None:
    """
    Recent match information
    URL: /battles2/users/:userID/matches
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_users_by_user_id_matches(user_id=user_id)

# Tool wrapper for NinjaKiwiAPI.get_battles2_users_by_user_id_homs
@mcp.tool
async def get_battles2_users_by_user_id_homs(
    context: fastmcp.server.context.Context,    user_id: str,) -> list[Battles2userhomrank] | None:
    """
    Recent hall of masters positions
    URL: /battles2/users/:userID/homs
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_users_by_user_id_homs(user_id=user_id)

# Tool wrapper for NinjaKiwiAPI.get_battles2_guild_by_guild_id
@mcp.tool
async def get_battles2_guild_by_guild_id(
    context: fastmcp.server.context.Context,    guild_id: str,) -> Battles2guild | None:
    """
    Information about a Battles 2 Guild/Clan
    URL: /battles2/guild/:guildID
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_guild_by_guild_id(guild_id=guild_id)

# Tool wrapper for NinjaKiwiAPI.get_battles2_guild_by_guild_id_war
@mcp.tool
async def get_battles2_guild_by_guild_id_war(
    context: fastmcp.server.context.Context,    guild_id: str,) -> Battles2guildwar | None:
    """
    A list of recent wars the guild has taken part in
    URL: /battles2/guild/:guildID/war
    """
    api_client: NinjaKiwiAPI = context.fastmcp.api_client
    return await api_client.get_battles2_guild_by_guild_id_war(guild_id=guild_id)
